...
## Purpose
Generate a summary report, in markdwon format, for each major build version or iteration that documents progress, decisions, and outcomes from the development cycle

## File Management

- Place the new report in the  progress_reports folder in the project root. if the progress_reports folder doesn't already exist, create it.
